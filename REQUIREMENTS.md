...
- The settings page must allow the user to select an Ollama model for Build.
...
- The user can select a Build model from available Ollama models in settings.
- The selected Build model is saved and restored on app restart.
